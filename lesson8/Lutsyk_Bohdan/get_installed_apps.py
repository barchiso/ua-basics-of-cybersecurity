...
# Дозволяє запускати системні команди (як в командному рядку)
import subprocess
import platform    # Дає інформацію про операційну систему
# Для роботи з системними функціями (вихід з програми, помилки)
import sys
# Для підказок типів даних (необов'язково, але корисно)
...
def get_windows_apps() -> list[str]:
    ...
    result = subprocess.run(
        ...
        # Кодування тексту (щоб підтримувати українські букви)
        encoding="utf-8",
